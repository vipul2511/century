...
export default class CustomerGrid extends Component {
  ...
  dataFetchStockItem = () => {
    var EditProfileUrl = `${BASE_URL}/dms-demo/FetchLoginEntityMasterData?logintoken=${this.state.token}&sourcetype=AndroidSalesPersonApp&startIndex=0&packetSize=500&selEntityId=${this.props.route.params.dataItem.orgid}&selEntityType=superstockist&reportDataSource=FetchEntityCustomersDetail`
