...
renderItem = ({ item,index }) => {
  ...
  return(
    <View key={index}>
     ...
     <Text style={{fontSize:15,flexWrap:'wrap',marginBottom:10,textAlign:'left'}}>{item.parentname}</Text>
     </View>
...
{this.state.language=="User defined date from and to date"?<View style={{flexDirection:'row'}}>
    ...
    />
           ...
           {!this.state.Nodata? <View style={{marginTop:8,marginBottom:5,marginLeft:5,}}>
                ...
                <Text style={{fontWeight:'bold',textAlign:'left'}}>Parent Name</Text></View>
